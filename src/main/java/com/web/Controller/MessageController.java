...
public class MessageController {
    ...
    public Object send(@Userid Long userId,        // 通过 @Userid 注解获取用户ID
        ...
        if (messageBody.getMessageType() == null) {
            // 修改说明：此处确保设置的消息类型为 Integer 类型，与 model.Message 中 messageType 属性保持一致
    ...
    public Object handleReaction(@RequestBody @Valid ReactionVo reactionVo, @Userid Long userId) { // Changed userId to Long
        ...
        return ResultUtil.Succeed("反应操作成功"); // Using existing ResultUtil for consistency in this controller
    }
