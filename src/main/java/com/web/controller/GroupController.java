...
public class GroupController {
    ...
    public ResponseEntity<ApiResponse<java.util.List<java.util.Map<String, Object>>>> getGroupMembers(
            @PathVariable Long groupId, @Userid Long userId) {
        try {
            java.util.List<java.util.Map<String, Object>> members = groupService.getGroupMembers(groupId, userId);
    ...
    public ResponseEntity<ApiResponse<String>> removeGroupMember(
        ...
        try {
            ...
            return ApiResponseUtil.badRequestString(e.getMessage());
        } catch (Exception e) {
