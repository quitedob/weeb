...
public class ContentReportController {
    ...
    public ResponseEntity<ApiResponse<ContentReport>> createReport(
        ...
        try {
            // 设置举报人ID
            ContentReport submittedReport = new ContentReport(userId, report.getContentType(), report.getContentId(), report.getReason());
            submittedReport.setDescription(report.getDescription());
            submittedReport.setMetadata(report.getMetadata());
            ...
            ContentReport createdReport = contentReportService.createReport(submittedReport);
