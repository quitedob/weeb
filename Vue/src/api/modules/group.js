...
export default {
  ...
  createGroup(data) {
    return instance.post('/api/group/create', data);
  },
  ...
  getGroupDetails(groupId) {
    return instance.get(`/api/group/${groupId}`);
  },
  ...
  getGroupMembers(groupId) {
    return instance.get(`/api/group/members/${groupId}`);
  },
  ...
  updateGroup(groupData) {
    ...
    return instance.put(`/api/group/${groupData.id}`, groupData);
  },
  ...
  inviteMembers(payload) { // payload: { groupId: string, userIds: string[] }
    return instance.post(`/api/group/${payload.groupId}/invite`, payload);
  },
  ...
  kickMember(payload) { // payload: { groupId: string, userIdToKick: string }
    return instance.post(`/api/group/${payload.groupId}/kick`, payload);
  },
  ...
  leaveGroup(groupId) {
    return instance.delete(`/api/group/quit/${groupId}`);
  },
